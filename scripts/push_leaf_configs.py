...
def send_config_to_group(config_name, nornir_group):
...
if __name__ == "__main__":
    ...
    # order of things
    send_config_to_group("pod1-lf1-interfaces", leaf1)
    send_config_to_group("pod1-lf2-interfaces", leaf2)
    ...
    send_config_to_group("pod1-lf1-network-instance-vrf-routing", leaf1)
    send_config_to_group("pod1-lf2-network-instance-vrf-routing", leaf2)
    send_config_to_group("pod1-rack1-system-network-instance", rack1)
    send_config_to_group("pod1-network-instance-vrf-mgmt-infra", leaves)
    send_config_to_group("pod1-routing-policy-vrf-leaks", leaves)
    send_config_to_group("pod1-network-instance-vrf-frontend", leaves)
    send_config_to_group("pod1-network-instance-vrf-backend", leaves)
